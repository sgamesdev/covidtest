...
<link href="removewatermarkeduard.css" rel="stylesheet" type="text/css">
    ...
    <title>Covid-19  | Editeaza flebotomistii </title>
                  ...
                  <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Numele complet</label>
                                            <input type="text" class="form-control" id="fullname" name="fullname"  placeholder="Introduceti numele complet..." pattern="[A-Za-z ]+" title="letters only" value="<?php echo $row['FullName'];?>" required="true">
                                        </div>
                                        <div class="form-group">
                                             <label>Numar de telefon</label>
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Introduceti numarul de telefon" pattern="[0-9]{10}" title="10 numeric characters only" value="<?php echo $row['MobileNumber'];?>" required="true" >
