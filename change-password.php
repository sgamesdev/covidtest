...
echo '<script>alert("Parola ta a fost schimbata.")</script>';
} else {

echo '<script>alert("Parola curenta este incorecta.")</script>';
}
}
...
<link href="removewatermarkeduard.css" rel="stylesheet" type="text/css">
    ...
    <title>Covid-19 Testari | Schimba parola</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Schimba parola</h1>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Schimba parola</h6>
                                </div>
                                <div class="card-body">
