...
if ($result) {
echo '<script>alert("Cererea testului a fost trimisa. Numarul comenzii este "+"'.$orderno.'")</script>';
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Covid19-Testare| Utilizatori inregistrati</h1>
...
<form method="post">
  <div class="row">
                       ...
                       <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="regmobilenumber" name="regmobilenumber" placeholder="Va rog introduceti numarul inregistrat de telefon" pattern="[0-9]{10}" title="numai 10 numere" required="true" maxlength="10">
                                        </div>
<div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" name="search" value="Cauta">                           
                             </div>
...
<h3 align="center" style="color:red">Rezultate dupa numarul de telefon "<?php echo $_POST['regmobilenumber'];?>"</h3>
<hr />
    <?php
...
<form name="newtesting" method="post">
 ...
 <div class="form-group">
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Informații de testare</h6>
                                </div>
                                <div class="card-body">
                             <div class="form-group">
