...
<link href="removewatermarkeduard.css" rel="stylesheet" type="text/css">
    ...
    <title>Covid-19 Testare| Profil admin</title>
...
?>
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Data inregistrarii: <?php  echo $row['AdminRegdate'];?></h6>
                                </div>
                                <div class="card-body">
     <div class="form-group">
                            <label>Nume Admin</label>
...
<?php } ?>
        <div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" name="update" id="update" value="Actualizeaza">                           
                             </div>                                        
