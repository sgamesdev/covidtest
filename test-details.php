...
echo '<script>alert("Atribuit flebotomistului cu succes.")</script>';
...
echo '<script>alert("Status actualizat")</script>';
...
<link href="removewatermarkeduard.css" rel="stylesheet" type="text/css">
    ...
    <title>Covid-19  | Detalii test</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Detalii test# <?php echo intval($_GET['oid']);?></h1>
<div class="row">
<?php 
$testid=intval($_GET['tid']);
...
<!-- personal information --->
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Informatii personale</h6>
                                </div>
                                <div class="card-body">
 ...
 <table class="table table-bordered"  width="100%" cellspacing="0">
    ...
    <td><?php echo $row['DateOfBirth'];?></td>
     ...
     <tr>
    <th>Act de identificare</th> 
    <td><?php echo $row['GovtIssuedId'];?></td>
    </tr>


     <tr>
    <th>Codul de pe act</th> 
...
<!-- Test Information --->
                         <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Informatii test</h6>
                                </div>
                                <div class="card-body">
...
<?php if($row['FinalReport']!=''):?>
  <tr>
    <th>Raport</th> 
    <td><a href="reportfiles/<?php echo $row['FinalReport'];?>" target="_blank">Descarca</a></td>
    </tr>

    <tr>
    <th>Data incarcarii raportului</th> 
...
<?php if($row['AssignedtoEmpId']==''): 
    ?>
      ...
      <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#assignto">Atribuire</button>
            </div>                                        
<?php else: 
...
<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#takeaction">Actioneaza</button>
<?php 
endif;
endif;?>    
                                </div>
...
<div class="row">
                         <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary" align="center">Istoric</h6>
                                </div>
                                <div class="card-body">
<?php if($num>0){
?>
...
<h4 align="center" style="color:red"> Nu exista istoric </h4>
         <?php } ?>           
...
<form method="post">
          <p>  <select class="form-control" name="assignto" required="true">
            <option value="">Selecteaza flebotomist</option>
...
endwhile;
  ?>
            ...
            <option value="On the Way for Collection">In drum spre colectare</option>
            <option value="Sample Collected">Proba colectata</option>
            <option value="Sent to Lab">Trimis spre laborator</option>
            <option value="Delivered">Test finalizat</option>
       ...
       <p id='reportfile'> Raport <span style="color:red; font-size:12px;">(Doc si PDF permise )</span>    <input type="file" name="report" id="report"></p>
       <p>
