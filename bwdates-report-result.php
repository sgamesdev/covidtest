...
<head>
    ...
    <title>Covid-Tms | B/w Data Raportului</title>
...
?>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">B/W Data raportului din <?php echo $fdate;?> to <?php echo $tdate;?> </h1>
    

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">B/W Datele rapoartelor</h6>
                        </div>
                        <div class="card-body">
...
?>
                                ...
                                <a href="test-details.php?tid=<?php echo $row['testid'];?>&&oid=<?php echo $row['OrderNumber'];?>" class="btn btn-info btn-sm" target="blank">Vezi detalii</a> 
